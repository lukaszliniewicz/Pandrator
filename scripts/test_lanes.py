...
TEST_LANES: dict[str, tuple[str, ...]] = {
    FAST_LANE: (
        ...
        "tests/test_audio_cpp_inventory_snapshot.py",
        ...
        "tests/test_media_edit_logic.py",
        ...
        "tests/test_speech_markup_edits.py",
        "tests/test_speech_markup_selection.py",
    ...
    "manager-serial": (
        ...
        "tests/test_manager_installed_models.py",
    ...
    "mcp-serial": (
        ...
        "tests/test_mcp_audiobook.py",
        "tests/test_mcp_architecture.py",
        "tests/test_mcp_boundary_types.py",
        ...
        "tests/test_mcp_compact_guidance.py",
        ...
        "tests/test_mcp_voice_catalog.py",
        "tests/test_mcp_voice_metadata.py",
        "tests/test_mcp_voice_lifecycle.py",
        "tests/test_mcp_voice_integration.py",
    ...
    "system-media-serial": (
        "tests/test_export_assembly_plan_selection.py",
        "tests/test_export_input_resolution.py",
    ...
    "web-03-serial": (
        ...
        "tests/test_voice_collections.py",
        "tests/test_voice_lifecycle_idempotency.py",
        "tests/test_voice_profile_schema.py",
        "tests/test_voice_reference_import.py",
        "tests/test_voice_categories.py",
        "tests/test_generation_cast_runtime.py",
        "tests/test_generation_controls.py",
        "tests/test_generation_rendering.py",
        "tests/test_legacy_generation_cast.py",
        "tests/test_performance_markup.py",
        "tests/test_performance_plans.py",
        "tests/test_performance_request_consistency.py",
        "tests/test_speech_markup.py",
        "tests/test_speech_optimization_markup.py",
    ...
    "web-05-serial": (
        "tests/test_audiobook_chunking_integration.py",
        "tests/test_audiobook_resegmentation.py",
        "tests/test_audiobook_setup.py",
        "tests/test_audio_cpp_parameters.py",
        "tests/test_dubbing_logical_passages.py",
        "tests/test_generation_audio_identity.py",
        "tests/test_generation_missing_only.py",
        "tests/test_generation_run_history_projection.py",
        "tests/test_generation_search.py",
        "tests/test_passage_regroup.py",
        "tests/test_regroup_history_batches.py",
        "tests/test_repair_batches.py",
        "tests/test_source_passage_backend.py",
        "tests/test_source_provisional_sentence_policy.py",
        "tests/test_speech_plan_history_summary.py",
        "tests/test_speech_plan_preview.py",
        "tests/test_speech_selection.py",
        "tests/test_speech_selection_guards.py",
        "tests/test_speech_block_passage_capacity.py",
        "tests/test_timing_repair_payload_kind.py",
        "tests/test_tts_voice_aliases.py",
    ...
    "web-06-serial": (
        ...
        "tests/test_stt_language_policy.py",
        "tests/test_tts_catalogue_policy.py",
    ...
    "web-07-serial": (
        ...
        "tests/test_web_generation_topology.py",
        "tests/test_web_voiceover_repair.py",
        ...
        "tests/test_web_provider_modalities.py",
