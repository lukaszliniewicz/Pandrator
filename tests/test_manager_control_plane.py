...
class ApiContractTests(unittest.TestCase):
    ...
    def test_recovery_assets_are_external_and_served_with_strict_headers(self):
        ...
        self.assertIn('id="open-software-maintenance"', html)
        self.assertIn('id="mcp-summary"', html)
        self.assertIn('id="mcp-action"', html)
        self.assertIn('aria-controls="software-maintenance"', html)
        self.assertIn('id="software-maintenance"', html)
        self.assertEqual(html.count('class="panel maintenance-overview"'), 1)
        self.assertIn('id="pandrator-maintenance-title"', html)
        self.assertIn('id="manager-maintenance-title"', html)
        ...
        self.assertIn("function openSoftwareMaintenance()", source)
        self.assertIn("function renderMcpAccess()", source)
        self.assertIn('runtime("pandrator.mcp", action)', source)
        ...
        self.assertIn('"/v1/diagnostics/bundle"', source)
        self.assertIn("operation.error_message", source)
        self.assertIn("Copy issue summary", html)
        ...
        self.assertIn(".maintenance-product-grid", css)
