...
def register_routes(flask_app: Flask, context: RouteContext) -> None:
    ...
    def replay_idempotency(reservation, *, etag_key: str | None = None):
    ...
    def inspect_voice_idempotency(
        ...
        *,
        ...
        """Replay a completed voice mutation before inspecting mutable state.
        ...
        referenced voice, sample, or artifact has changed or disappeared.
        """
        ...
        try:
            with database.immediate_session() as db_session:
                ...
                replay = replay_idempotency(reservation, etag_key=etag_key)
    ...
    def audio_cpp_catalogue():
        string_filters = {
            ...
            for name in ("category", "family", "query", "language", "capability")
        }
