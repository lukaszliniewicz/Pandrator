...
_DESCRIPTIONS: dict[str, dict[str, str]] = {
    ...
    "output": {
        ...
        "video_tail_extension_max_ms": "Maximum terminal speech overrun, in milliseconds, that a voiceover media export may cover by freezing the last video frame; existing timeline positions are preserved and the tail is reencoded. Larger overruns are rejected rather than silently clipped; 0 keeps the strict timeline with no extension.",
