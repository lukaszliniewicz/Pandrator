...
"/api/v1/sessions/{sessionId}/stages/{stageKey}/settings-mismatches": {"get": {"operationId": "getStageSettingsMismatches", "responses": {"200": {"description": "Prerequisite settings changed since the stored artifacts were created"}}}},
    ...
    paths.update({
        ...
        "/api/v1/manager/status": {"get": operation("getManagerStatus", "Local manager availability and status")},
        "/api/v1/manager/components": {"get": operation("listManagerComponents", "Manager component inventory")},
        "/api/v1/manager/doctor": {"get": operation("getManagerDoctorReport", "Non-mutating host diagnostics")},
        "/api/v1/manager/legacy": {"get": operation("getManagerLegacyImportReport", "Read-only legacy workspace inspection")},
        "/api/v1/manager/legacy/import": {"post": operation("importManagerLegacyWorkspace", "Import the exact reviewed legacy workspace", "ManagerLegacyImportRequest")},
        "/api/v1/manager/services": {"get": operation("listManagerServices", "Manager service inventory")},
        "/api/v1/manager/releases": {"get": operation("listManagerReleases", "Accepted product releases and activation slots")},
        "/api/v1/manager/releases/plans": {"post": operation("createManagerReleasePlan", "Immutable signed product release plan", "ManagerReleasePlanRequest", "201")},
        "/api/v1/manager/uninstall/plans": {"post": operation("createManagerUninstallPlan", "Immutable whole-product uninstall plan", "ManagerUninstallPlanRequest", "201")},
        "/api/v1/manager/plans": {"post": operation("createManagerPlan", "Immutable manager plan", "ManagerPlanRequest", "201")},
        "/api/v1/manager/operations": {
            "get": operation("listManagerOperations", "Durable manager operations"),
            "post": operation("submitManagerOperation", "Manager operation accepted", "ManagerOperationRequest", "202"),
        },
        "/api/v1/manager/operations/{operationId}": {"get": operation("getManagerOperation", "Durable manager operation")},
        "/api/v1/manager/operations/{operationId}/tasks": {"get": operation("listManagerOperationTasks", "Durable manager operation tasks")},
        "/api/v1/manager/operations/{operationId}/cancel": {"post": operation("cancelManagerOperation", "Safe cancellation requested")},
        "/api/v1/manager/runtime/{action}": {"post": operation("controlManagerRuntime", "Managed runtime action completed", "ManagerRuntimeRequest")},
        "/api/v1/manager/logs": {"get": operation("getManagerLogs", "Bounded managed-service log tail")},
