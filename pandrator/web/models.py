...
class SessionRecord(Base):
    ...
    source_language: Mapped[str] = mapped_column(String(40), nullable=False, default="auto")
...
class GenerationSegment(Base):
    ...
    node_kind: Mapped[str] = mapped_column(String(40), nullable=False, default="paragraph")
