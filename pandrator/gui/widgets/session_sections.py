...
class DubbingSection(QFrame):
    def __init__(self, parent=None):
        ...
        trans_layout.setColumnMinimumWidth(1, 240)
        trans_layout.setColumnStretch(1, 0)
        trans_layout.setColumnStretch(2, 0)
        trans_layout.setColumnMinimumWidth(3, 240)
        trans_layout.setColumnStretch(3, 0)
        ...
        transl_layout.setColumnMinimumWidth(1, 240)
        transl_layout.setColumnStretch(1, 0)
        transl_layout.setColumnStretch(2, 0)
        transl_layout.setColumnMinimumWidth(3, 240)
        transl_layout.setColumnStretch(3, 0)
        transl_layout.setColumnStretch(4, 1)
