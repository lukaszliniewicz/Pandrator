...
[Pandrator 0.8.8](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.8)
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.8)
...
```bash
chmod +x PandratorManager-0.9.14-x86_64.AppImage
./PandratorManager-0.9.14-x86_64.AppImage
```
