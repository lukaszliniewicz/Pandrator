...
[Pandrator 0.6.9](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.9)
with Pandrator Manager 0.9.8. The Manager installs Pandrator, launches it, and
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.9)
...
```bash
chmod +x PandratorManager-0.9.8-x86_64.AppImage
./PandratorManager-0.9.8-x86_64.AppImage
```
