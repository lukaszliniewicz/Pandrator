...
[Pandrator 0.8.0](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.0)
with Pandrator Manager 0.9.10. The Manager installs Pandrator, launches it, and
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.0)
...
```bash
chmod +x PandratorManager-0.9.10-x86_64.AppImage
./PandratorManager-0.9.10-x86_64.AppImage
```
