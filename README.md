...
[Pandrator 0.6.7](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.7)
with Pandrator Manager 0.9.7. The Manager installs Pandrator, launches it, and
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.7)
...
```bash
chmod +x PandratorManager-0.9.7-x86_64.AppImage
./PandratorManager-0.9.7-x86_64.AppImage
```
