...
[Pandrator 0.8.1](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.1)
with Pandrator Manager 0.9.11. The Manager installs Pandrator, launches it, and
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.1)
...
```bash
chmod +x PandratorManager-0.9.11-x86_64.AppImage
./PandratorManager-0.9.11-x86_64.AppImage
```
