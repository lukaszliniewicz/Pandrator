...
[Pandrator 0.8.6](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.6)
...
1. Download
   [PandratorManager-0.9.14-windows-x86_64.exe](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.8.6/PandratorManager-0.9.14-windows-x86_64.exe).
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.6)
