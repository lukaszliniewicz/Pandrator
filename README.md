...
[Pandrator 0.6.2](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.2)
with Pandrator Manager 0.9.2. The Manager installs Pandrator, launches it, and
...
[release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.2)
...
```bash
chmod +x PandratorManager-0.9.2-x86_64.AppImage
./PandratorManager-0.9.2-x86_64.AppImage
```
