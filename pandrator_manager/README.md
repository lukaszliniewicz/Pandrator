...
The current release is 0.9.12. For most users, the easiest installation is the
Windows executable or Linux AppImage on the
[Pandrator 0.8.2 release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.2).
...
- Linux:
  [PandratorManager-0.9.12-x86_64.AppImage](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.8.2/PandratorManager-0.9.12-x86_64.AppImage)
...
PandratorManager-0.9.12-windows-x86_64.exe setup --workspace D:\path\to\parent
```
