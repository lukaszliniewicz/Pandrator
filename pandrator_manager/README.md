...
The current release is 0.9.8. For most users, the easiest installation is the
Windows executable or Linux AppImage on the
[Pandrator 0.6.9 release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.9).
...
- Windows:
  [PandratorManager-0.9.8-windows-x86_64.exe](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.6.9/PandratorManager-0.9.8-windows-x86_64.exe)
- Linux:
  [PandratorManager-0.9.8-x86_64.AppImage](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.6.9/PandratorManager-0.9.8-x86_64.AppImage)
...
PandratorManager-0.9.8-windows-x86_64.exe setup --workspace D:\path\to\parent
```
