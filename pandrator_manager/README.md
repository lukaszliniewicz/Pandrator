...
[Pandrator 0.8.9 release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.9).
...
- Windows:
  [PandratorManager-0.9.14-windows-x86_64.exe](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.8.9/PandratorManager-0.9.14-windows-x86_64.exe)
- Linux:
  [PandratorManager-0.9.14-x86_64.AppImage](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.8.9/PandratorManager-0.9.14-x86_64.AppImage)
