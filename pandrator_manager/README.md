...
[Pandrator 0.6.8 release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.6.8).
...
- Windows:
  [PandratorManager-0.9.8-windows-x86_64.exe](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.6.8/PandratorManager-0.9.8-windows-x86_64.exe)
- Linux:
  [PandratorManager-0.9.8-x86_64.AppImage](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.6.8/PandratorManager-0.9.8-x86_64.AppImage)
