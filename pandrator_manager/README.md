...
[Pandrator 0.8.10 release page](https://github.com/lukaszliniewicz/Pandrator/releases/tag/v.0.8.10).
...
- Linux:
  [PandratorManager-0.9.14-x86_64.AppImage](https://github.com/lukaszliniewicz/Pandrator/releases/download/v.0.8.10/PandratorManager-0.9.14-x86_64.AppImage)
