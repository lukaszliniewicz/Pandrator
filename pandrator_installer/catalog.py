...
COMPONENTS: dict[str, ComponentDefinition] = {
    ...
    "crispasr": ComponentDefinition(
        key="crispasr",
        label="CrispASR",
        config_flag="crispasr_support",
        paths=("CrispASR",),
    ...
    "xtts_finetuning": ComponentDefinition(
        ...
        paths=("easy_xtts_trainer", "envs/easy_xtts_trainer", "envs/whisperx_installer"),
        markers=(
    ...
    "rvc": ComponentDefinition(
        ...
        paths=("rvc-python",),
        markers=("rvc-python/run.py", "rvc-python/run.sh", "rvc-python/pyproject.toml"),
