...
# Match the manager catalogue default.  An explicit 0.6B selection remains
# supported for Base-model voice cloning; this value is only for legacy
# configurations that predate the persisted model-size setting.
